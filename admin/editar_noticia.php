        ...
        <div class="container">
            ...
            <?php } elseif (!$resultado) { ?>
                <div class="alert alert-danger" role="alert">
                  ...
                  <span class="sr-only">Error:</span> No se pudo Modificar la Noticia <em><?php echo $noticia->Noticia_Titulo; ?></em>
                </div>
                </br>
            ...
            <?php } else { ?>
                <div class="alert alert-success" role="alert">
                  ...
                  <span class="sr-only">Confirmación:</span> La Noticia <em><?php echo $noticia->Noticia_Titulo; ?></em> se Modificó correctamente.
                </div>     
                </br>
                <a href="./" class = "btn btn-default">Volver</a>           
            <?php } ?>
